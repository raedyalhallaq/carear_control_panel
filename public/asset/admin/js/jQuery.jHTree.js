...
(function ($) {
    ...
    $.widget("jHtree.jHTree", {
        ...
        _createNode: function (node, parentLiNode) {
            ...
            var nodeLiElements = '<li id="' + node.id + '" class="tnode" >' + beforeDiv + '<img src='+'"' +
               "/uploads/"+ node.head +'"'+" " +'alt="photo" width="50px" height="50px" >'+ '<div class="ui-widget-content ui-corner-bl ui-corner-br">' +
